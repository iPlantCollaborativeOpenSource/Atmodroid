...
public class AtmoImage {
	...
	private String name, desc, tags, id, location, owner, state, arch, type, ramdisk, kernel;
	...
	public String toString() {
		return "AtmoImage [name=" + name + ", desc=" + desc + ", tags=" + tags
				+ ", id=" + id + ", location=" + location + ", owner=" + owner
